"""
Django settings for macromate project.

Configuración profesional para entorno académico/producción
...
#         'NAME': config('DB_NAME', 'macromate_db'),
#         'USER': config('DB_USER', 'macromate_user'),
#         'PASSWORD': config('DB_PASSWORD', 'macromate_pass'),
...
# =============================================================================
# DRF & JWT CONFIGURATION - CONFIGURACIÓN PROFESIONAL
# =============================================================================
...
# Cache Configuration (opcional para producción)
CACHES = {
    'default': {
